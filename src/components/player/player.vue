<template>
	<div class="player" v-show="playlist.length>0 && !showLogin">
		<transition name="normal" @enter="enter" @after-enter="afterEnter" @leave="leave" @after-leave="afterLeave">
			<div class="normal-player" v-show="fullScreen">
				<div class="background">
					<img width="100%" height="100%" :src="currentSong.localImage||currentSong.image">
				</div>
				<div class="top">
					...
					<div class="middle-l" ref="middleL">
						<div class="cd-wrapper" ref="cdWrapper">
							<div class="cd" :class="cdCls">
								<img class="image" :src="currentSong.localImage||currentSong.image">
							</div>
						</div>
		...
		<transition name="mini">
			<div class="mini-player" v-show="!fullScreen" @click="open">
				<div class="icon">
					<img :class="cdCls" width="40" height="40" :src="currentSong.localImage || currentSong.image">
				</div>
				<div class="text">
...
<script type="text/ecmascript-6">
	...
	import { getSingleSong } from 'api/player'
	import ProgressBar from 'base/progress-bar/progress-bar'
	import ProgressCircle from 'base/progress-circle/progress-circle'
	import {playMode} from 'common/js/config'
	import {shuffle,getValue} from 'common/js/util'
	import Lyric from 'lyric-parser'
	import Scroll from 'base/scroll/scroll'
	import {playerMixin} from 'common/js/mixin'
	import Playlist from 'components/playlist/playlist'
	import {addFavorite,queryFavorite,deleteFavorite,setRecord} from "api/song";
